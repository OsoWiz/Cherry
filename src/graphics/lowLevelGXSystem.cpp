...
void GXSystem::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo) {
    createInfo = {};
...
void GXSystem::setupDebugMessenger()
{
...
void GXSystem::pickPhysicalDevice()
{
...
void GXSystem::createLogicalDevice()
{
...
void GXSystem::createRenderPass()
{
...
void GXSystem::createFramebuffers()
{
...
void GXSystem::createCommandPool()
{
...
bool GXSystem::checkDeviceExtensionSupport(VkPhysicalDevice device)
{
    uint32_t extCount = 0;
...
bool GXSystem::checkValidationLayerSupport()
{
    uint32_t layerCount;
...
bool GXSystem::isDeviceSuitable(VkPhysicalDevice device)
{
...
int GXSystem::rateDevice(VkPhysicalDevice device)
{
    VkPhysicalDeviceProperties props; //properties
    VkPhysicalDeviceFeatures feats; //and features of the gpu
    vkGetPhysicalDeviceProperties(device, &props);
...
SwapChainSupportDetails GXSystem::querySwapChainSupport(VkPhysicalDevice device)
{
...
std::vector<const char*> GXSystem::getRequiredExtensions()
{
    uint32_t extCount;
...
VkSurfaceFormatKHR GXSystem::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR> availableFormats)
{
...
VkPresentModeKHR GXSystem::chooseSwapPresentMode(const std::vector<VkPresentModeKHR> availableModes)
{
...
VkExtent2D GXSystem::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities)
{
...
VKAPI_ATTR VkBool32 VKAPI_CALL GXSystem::debugCallback(
...
VkShaderModule GXSystem::createShaderModule(const std::vector<char>& code)
{
...
VkResult GXSystem::CreateDebugUtilsMessengerEXT(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT* pDebugMessenger) {
...
void GXSystem::DestroyDebugUtilsMessengerEXT(VkInstance instance, VkDebugUtilsMessengerEXT debugMessenger, const VkAllocationCallbacks* pAllocator) {
